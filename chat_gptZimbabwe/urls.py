...
from users import views as user_auth_views
...
urlpatterns = [
    ...
    path('account_activation_sent/', user_auth_views.account_activation_sent, name='account_activation_sent'),
    path('activate/<str:uidb64>/<str:token>/', user_auth_views.activate, name='activate'),
