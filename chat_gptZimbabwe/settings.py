"""
Django settings for chat_gptZimbabwe project.
...
SECRET_KEY = 'django-insecure-tu=@@9959-ebr$-q(shm#=9+-^0)@(=os-g@!8*n7u9qnebek@'
...
WSGI_APPLICATION = 'chat_gptZimbabwe.wsgi.application'
